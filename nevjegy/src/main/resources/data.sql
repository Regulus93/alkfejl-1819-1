...
INSERT INTO FEEDBACK (ID, VERSION, RATE_VALUE, TEXT, BUSINESS_CARD_ID) VALUES (1,1,3,'He is repaired my washing machine, I can offer it.',2);
INSERT INTO FEEDBACK (ID, VERSION, RATE_VALUE, TEXT, BUSINESS_CARD_ID) VALUES (2,1,3,'Tasty bread. Its okay.',3);
INSERT INTO FEEDBACK (ID, VERSION, RATE_VALUE, TEXT, BUSINESS_CARD_ID) VALUES (3,1,3,'Average math teacher.',4);
INSERT INTO FEEDBACK (ID, VERSION, RATE_VALUE, TEXT, BUSINESS_CARD_ID) VALUES (4,1,1,'It is a worst IT teacher ever...',5);
INSERT INTO FEEDBACK (ID, VERSION, RATE_VALUE, TEXT, BUSINESS_CARD_ID) VALUES (5,1,5,'It is a quite enough good teacher!',5);